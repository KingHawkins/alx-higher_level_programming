...
def matrix_mul(m_a, m_b):
    ...
    if len(m_a) == 2 and len(m_b) == 2:
        ...
        one = [cum[0][0]*m_a[0][0] + cum[0][1]*m_a[0][1],  cum[1][0]*m_a[0][0] + cum[1][1]*m_a[0][1]]
        sec = [m_a[1][0]*cum[0][0] + m_a[1][1]*cum[0][1],  m_a[1][0]*cum[1][0] + m_a[1][1]*cum[1][1]]
        return ([one, sec])
    elif len(m_a) == 1 and len(m_b) == 2:
        one = [m_a[0][0]*m_b[0][0] + m_a[0][1]*m_b[1][0],  m_a[0][0]*m_b[0][1] + m_a[0][1]*m_b[1][1]]
        return ([one])
    elif len(m_a[0]) == 2 and len(m_b[0]) == 2:
        new = [m_a[0][0]*m_b[0][0] + m_a[0][1]*m_b[0][0], m_a[0][0]*m_b[0][1] + m_a[0][1]*m_b[0][1]]
        return ([new])
